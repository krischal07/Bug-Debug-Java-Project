 ...
 * @author kr
 */
public class RatingPanel extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RatingPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

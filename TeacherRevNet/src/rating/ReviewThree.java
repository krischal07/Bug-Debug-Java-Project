 ...
 * @author kr
 */
public class ReviewThree extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Ram Kumar");
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 40, 250, 40));
...
//        new Star().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReviewThree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

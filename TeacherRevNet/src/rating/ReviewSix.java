 ...
 * @author kr
 */
public class ReviewSix extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Lebron Shrestha");
...
//        JOptionPane.showMessageDialog(this, "Redirecting to Dashboard.....");
     ...
     try {
                ...
                ps.setString(1, "Lebron Shrestha");
...
//        new Star().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReviewSix.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

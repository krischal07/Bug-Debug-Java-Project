 ...
 * @author kr
 */
public class ReviewFour extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Hari Chapagain");
...
//        new Star().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReviewFour.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

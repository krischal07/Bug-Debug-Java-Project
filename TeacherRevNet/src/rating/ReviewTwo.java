 ...
 * @author kr
 */
public class ReviewTwo extends javax.swing.JFrame {
...
//        new Star().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReviewTwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

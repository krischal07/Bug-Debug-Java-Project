 ...
 * @author kr
 */
public class QAsix extends javax.swing.JFrame {
    private String teacherName;
    /**
     * Creates new form QAone
     */
    public QAsix(String teacherName) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("How relevant and up-to-date is the course material provided by the teacher?");
        jPanel4.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 770, 40));
...
//            }
        ...
        if (textFieldContent.isEmpty()) {
            ...
            new QAseven(teacherName).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QAsix("Teacher1").setVisible(true);
            }
        });
    }

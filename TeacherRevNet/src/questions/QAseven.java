 ...
 * @author kr
 */
public class QAseven extends javax.swing.JFrame {

    /**
     * Creates new form QAone
     */
    private String teacherName;
    public QAseven(String teacherName) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Does the teacher encourage questions and class participation? How?");
        ...
        jLabel5.setText("Engagement & Interaction:");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 540, 40));
...
String textFieldContent = jTextField1.getText().trim();
        if (textFieldContent.isEmpty()) {
            ...
            new QAeight(teacherName).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QAseven("Teacher1").setVisible(true);
            }
        });
    }

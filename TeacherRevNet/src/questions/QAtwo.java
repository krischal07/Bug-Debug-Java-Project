 ...
 * @author kr
 */
public class QAtwo extends javax.swing.JFrame {

    /**
     * Creates new form QAone
     */
    private String teacherName;
    public QAtwo(String teacherName) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("How effective is the teacher in explaining concepts?");
        ...
        jLabel5.setText("2. Teaching Effectiveness:");
...
String textFieldContent = jTextField1.getText().trim();
        if (textFieldContent.isEmpty()) {
            ...
            new QAthree(teacherName).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QAtwo("Teacher 1").setVisible(true);
            }
        });
    }

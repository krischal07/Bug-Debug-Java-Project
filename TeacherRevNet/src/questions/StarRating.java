 ...
 * @author kr
 */
public class StarRating extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StarRating.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
